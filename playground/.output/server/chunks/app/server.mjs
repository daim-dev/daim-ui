...
const components = {};
function componentsPlugin_f6e6e14a(nuxtApp) {
...
const vueuseHead_4b0c1dc6 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_0b5221ba = defineNuxtPlugin((nuxtApp) => {
...
const router_081991c5 = defineNuxtPlugin((nuxtApp) => {
  const routes = [];
  const hooks = {
    "navigate:before": [],
    "resolve:before": [],
...
const unocss_d9efc1e6 = () => {
};
const _plugins = [
  preload,
  componentsPlugin_f6e6e14a,
  vueuseHead_4b0c1dc6,
  plugin_0b5221ba,
  router_081991c5,
  unocss_d9efc1e6
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-48cbc257><div class="fixed left-0 right-0 spotlight z-10" data-v-48cbc257></div><div class="max-w-520px text-center z-20" data-v-48cbc257><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-48cbc257>${__props.statusCode}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-48cbc257>${__props.description}</p><div class="w-full flex items-center justify-center" data-v-48cbc257>`);
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-48cbc257"]]);
const _sfc_main$5 = {
  __ssrInlineRender: true,
  props: {
    appName: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-5db8226b><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-5db8226b></div><div class="max-w-520px text-center" data-v-5db8226b><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-5db8226b>${__props.statusCode}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-5db8226b>${__props.description}</p></div></div>`);
    };
  }
};
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-5db8226b"]]);
const _sfc_main$3 = {
  __ssrInlineRender: true,
  props: {
    error: Object
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<button${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    type: _ctx.type,
    class: [_ctx.classes, "btn"]
  }, _ctx.$attrs, _attrs))}>`);
  serverRenderer.exports.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
    _push(`${serverRenderer.exports.ssrInterpolate(_ctx.text)}`);
  }, _push, _parent);
  _push(`</button>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_daim_button = __nuxt_component_0;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div>Nuxt module playground!</div><div>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_daim_button, { variant: "primary" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Primary`);
      } else {
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_daim_button, { variant: "secondary" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`secondary`);
      } else {
        return [
          vue_cjs_prod.createTextVNode("secondary")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_daim_button, { variant: "link" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`link`);
      } else {
        return [
          vue_cjs_prod.createTextVNode("link")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_daim_button, { size: "sm" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`small`);
      } else {
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_daim_button, { size: "lg" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`large`);
      } else {
        return [
          vue_cjs_prod.createTextVNode("large")
        ];
      }
    }),
    _: 1
